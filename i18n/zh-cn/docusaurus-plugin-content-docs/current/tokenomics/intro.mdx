...
* [IDO 计算](/docs/community-event/archived-event/ido/intro) + 流动资金池([Raydium](https://raydium.io/swap/?from=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&to=CPXDs2uhNwDKAt9V3vXvtspv9U7rsQ2fVr1qAUDmuCaq), [STEP](https://app.step.finance/#/swap))
  * `26,424,295.15` + `≒3,384,006 + 395,778` ≒ `30,204,079.15` CPX 
  * `≒ 5.715% of total`

## 什么是 CPX？

[CPX token](https://solscan.io/token/CPXDs2uhNwDKAt9V3vXvtspv9U7rsQ2fVr1qAUDmuCaq) 是一个用于 Circlepod Protocol 生态系并且强而有力的代币，您可以使用它来进行应用活动，也可以用于治理。
