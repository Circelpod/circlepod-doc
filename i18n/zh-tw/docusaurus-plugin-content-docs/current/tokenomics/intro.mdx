...
* [IDO 計算](/docs/community-event/archived-event/ido/intro) + 流動資金池([Raydium](https://raydium.io/swap/?from=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&to=CPXDs2uhNwDKAt9V3vXvtspv9U7rsQ2fVr1qAUDmuCaq), [STEP](https://app.step.finance/#/swap))
  * `26,424,295.15` + `≒3,384,006 + 395,778` ≒ `30,204,079.15` CPX 
  * `≒ 5.715% of total`

## 什麼是 CPX？

[CPX token](https://solscan.io/token/CPXDs2uhNwDKAt9V3vXvtspv9U7rsQ2fVr1qAUDmuCaq) 是一個用於 Circlepod Protocol 生態系並且強而有力的代幣，您可以使用它來進行應用活動，也可以用於治理。
