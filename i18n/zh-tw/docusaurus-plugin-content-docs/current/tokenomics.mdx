...
* Team `(42.9%)`: 團隊持有，並於 4 年內解鎖。`79,272,885.45`顆
* Liquidity `(14.3%)`: 用於維持 Token 流動性。共計 `26,424,295.15`顆。
* Community Airdrops `(14.3%)`: 社群空投，用於行銷活動與市場運營。共計 `26,424,295.15` 顆。
* Community Sale-1 `(8.6%)`: 社群銷售，對於積極參與社群的朋友銷售。共計 `15,854,577.09` 顆。
* Community Sale-2 `(5.7%)`: 第二波社群銷售，對於積極參與社群的朋銷售。共計 `10,569,718.06`
* Private Sale `(14.3%)`: 機構或私人投資銷售。共計 `26,424,295.15` 顆。
...
* Team `(30%)`: 團隊持有，Genesis 與每年獲得，並於獲得時鎖定4年，共計 8 年。共計 `158,545,770.90`顆
* Liquidity `(5%)`: 用於維持 Token 流動性。共計 `26,424,295.15`顆。
* Community Airdrops `(15%)`: 社群空投，用於行銷活動與市場運營。共計 `79,272,885.45` 顆。
* Community Sale-1 `(3%)`: 社群銷售，對於積極參與社群的朋銷售。共計 `15,854,577.09` 顆。
* Community Sale-1 `(2%)`: 第二波社群銷售，對於積極參與社群的朋銷售。共計 `10,569,718.06` 顆。
* Private Sale `(5%)`: 機構或私人投資銷售。共計 `26,424,295.15` 顆。
...
團隊持有共計總供應量的 `30%`，Genesis 與每年獲得，為了應用更長遠以及社群與投資人利益，我們決定更嚴格的鎖定策略，獲得時鎖定 4 年，共計 8 年。共計 `158,545,770.90`顆，解鎖圖表如下：
