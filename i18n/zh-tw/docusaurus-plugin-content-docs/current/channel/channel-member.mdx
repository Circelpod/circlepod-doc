...
* Vault: Available balances a zero-interest earning token account with no restrictions.
* Pending Withdrawal Vault: unstaked funds incurring an unbonding timelock.(7 day)
